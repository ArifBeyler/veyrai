Help me integrate RevenueCat SDK into my fitswap app. I need to:
...
2. Configure it with my API key: test_ZlrmixGXfOlxOaNTwnPJmMtpKNG

3. Set up basic subscription functionality in React Native

4. Set up entitlement checking for: fitswap Pro
...
- Entitlement checking for fitswap Pro
